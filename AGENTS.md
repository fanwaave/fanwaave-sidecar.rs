# fanwaave — fanwaave-sidecar.rs

Canonical `fanwaave-sidecar.rs` for [`fanwaave`](https://github.com/fanwaave).
...
- This repository: https://github.com/fanwaave/fanwaave-sidecar.rs
...
- Package / service name: `fanwaave-sidecar`
